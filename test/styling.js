   ...
   item
	...
	it('should fail on extra spaces', function()
	{
      ...
      `
		...
		chai.expect(() => styler(style)).to.throw('Invalid indentation (extra leading spaces)')
	})
	...
	it('should fail on mixed tabs and spaces', function()
	{
      ...
      `
		...
		chai.expect(() => styler(style)).to.throw('Invalid indentation (mixed tabs and spaces)')
	})
	...
	it('should fail on messed up tabulation', function()
	{
      ...
      `
		...
		chai.expect(() => styler(style)).to.throw('Invalid indentation at line')
	})
	...
	it('should fail on blank styles', function()
	{
      ...
      `
		...
		chai.expect(() => styler(style)).to.throw('Not enough lines')
	})
    ...
    test 2
      `
		...
		chai.expect(() => styler(style)).to.throw('Same indentation')
	})
})